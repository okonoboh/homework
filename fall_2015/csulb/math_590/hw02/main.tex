...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Bonus%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
   \item[\textbf{Bonus.}]  Let $G$ be a connected graph. If for any two vertices
                           ...
                           automorphisms is \textbf{vertex transitive}. Assume
                           vertex transitivity. Then $\text{Aut}(G)$ is
                           \textbf{edge transitive} when for any pairs
                           of points, $x_1 \sim y_1$ and $x_2 \sim y_2$ there 
                           exists $\alpha \in \text{Aut}(G)$ such that
                           $\alpha(x_1) = x_2$ and $\alpha(y_1) = y_2$.

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1.3.15%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[1.3.15]  Prove that the order of an element in $S_n$ equals the least
      ...
      ${\sigma_j}^s = 1$, then it follows by Lemma 1.3.1 that $|\sigma_j| \mid s$,
      a contradiction. Thus ${\sigma_j}^s \neq 1$. So there exist two non-equal elements $a_1, a_2 \in \sigma_j$ such that
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1.4.10%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[1.4.10]  Let $G = \left\{\left(\begin{tabular}{@{}cc@{}}
      ...
      \begin{enumerate}
         ...
         \item Since $G$ is nonempty, associate under matrix multiplication,

   ...
   \item[4.2.7]   Let $Q_8$ be the quaternion group of order 8.
      ...
      \begin{enumerate}
         ...
         \item Suppose to the contrary that $Q_8$ is isomorphic to a subgroup of
               ...
               By Proposition 4.1, there exists an action, $\phi$, of $Q_8$ on
               $A = \{1, 2, \ldots, n\}$, where the kernel of $\phi$  is the
               kernel of $\pi$. Since $\pi$ is injective, its kernel is trivial,
               so that the kernel of $\phi$ is also trivial. Let
               ...
               kernel of $\phi$. That is, the kernel of $\phi$ is not

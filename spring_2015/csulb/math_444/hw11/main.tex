   ...
   \item Consider the veracity or falsehood of each of the following statements.
      ...
      \begin{enumerate}[label=\protect\circled{\arabic*}]
         ...
         \item False.
               ...
               \textbf{Counterexample.} Consider the set
               $$S = \left\{\left(\begin{tabular}{@{}cc@{}}
                  1 & $b$ \\
                  0 & 0
               \end{tabular}\right) : b \in \Z\right\} \cup I_2 \cup
               \left(\begin{tabular}{@{}cc@{}}
                  0 & 0 \\
                  0 & 0
               \end{tabular}\right).$$
               Define $A + B = 0$ for all $A, B \in S$. We can easily show that
               $S$ is closed under the usual multiplication, so that $S$ is a
               ring. Notice that every element of $S$ is idempotent, but $S$ is
